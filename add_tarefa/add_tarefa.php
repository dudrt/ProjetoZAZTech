...
<div class="div_top">
<a href="../index.php" ><img src="https://www.zaztech.com.br/wp-content/uploads/2022/09/Sem-Titulo-1-1.png" style="width:200px"/></a>
...
<div class="div_left">
    <label for="nome">Digite o nome da Tarefa</label>
        <input class="input_nome" id="nome" type="text" placeholder="Nome da Tarefa..." name="nome" maxlength="100">
        <label for="desc">Descrição da Tarefa</label>
        <textarea class="input_desc" type="text" id="desc" Placeholder="Descrição..." name="desc" maxlength="1000"></textarea>
        </div>
        <div class="div_right">
...
mysqli_close($banco);
        ...
        <input class="button_cancel" type="button" style="cursor:pointer ;" value="Cancelar">
        <input class="button_submit" type="submit" style="cursor:pointer ;">
